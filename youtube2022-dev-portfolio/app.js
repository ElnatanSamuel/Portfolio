...
// const jobTitles2 = document.querySelectorAll(".jobTitle2");
...
window.addEventListener("scroll", () => {
  ...
  jobTitles[1].style.transform = `translateX(calc(650vh - ${offsetY}px))`;
  // jobTitles2[0].style.transform = `translateX(calc(-100vh + ${offsetY}px))`;
  projectsTitle.style.transform = `translateY(calc(200vh - ${offsetY}px))`;
  // phones[0].style.transform = `translateX(calc(300vh - ${offsetY}px))`;
